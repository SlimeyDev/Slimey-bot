...
async def on_guild_join(guild):
    ...
    embed.set_footer(icon_url="https://i.ibb.co/9t7bbhY/Slimey.jpg", text="Slimey bot")
    try:
...
async def ping(ctx):
    em = discord.Embed(
        title="Pong!", description=f"{round(bot.latency*1000)}ms", color=discord.Colour.purple())
